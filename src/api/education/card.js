...
const api = {
  ...
  saveEduAchClassStudent: '/education/achclass/saveEduAchClassStudent ', //录入学员保存
  listAchClassStudent: '/education/achclass/listAchClassStudent', //录入学员保存
  listAchClassScore: '/education/achclass/listAchClassScore', //教研评分回显
  saveEduClassScore: '/education/achclass/saveEduClassScore', //教研评分提交
...
export function listStuCardNoClass(params) {
  return axios({
    url: `${api.listStuCardNoClass}`,
    method: 'get',
    params: params
  })
}

export function saveEduAchClassStudent(params) {
  return axios({
    url: api.saveEduAchClassStudent,
    method: 'post',
    data: QS.stringify(params)
  })
}
...
export function listAchClassScore(params) {
  return axios({
    url: api.listAchClassScore,
    method: 'get',
    params: params
  })
}

export function saveEduClassScore(params) {
  return axios({
    url: api.saveEduClassScore,
    method: 'post',
    data: QS.stringify(params)
  })
}
