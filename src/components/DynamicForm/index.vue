    ...
    <div class="left-board">
      ...
      <el-scrollbar class="left-scrollbar">
        <!-- <el-tabs v-model="activeTabName" :stretch="true">
          <el-tab-pane label="基本组件" name="common"> -->
        <div class="components-list">
          ...
          <div class="components-title"><svg-icon icon-class="component" />自定义组件</div>
          <draggable
            class="components-draggable"
            :list="returnPremines"
            :group="{ name: 'componentsGroup', pull: 'clone', put: false }"
            ...
            @end="onEnd"
          >
            <div v-for="(element, index) in returnPremines" :key="index" class="components-item" @click="addComponent(element)">
              <div class="components-body">
                <svg-icon :icon-class="element.tagIcon" />
                {{ element.label }}
              </div>
        ...
        <!-- </el-tab-pane>
          <el-tab-pane label="定制组件" name="custom">
            <div class="components-list">
              <div class="components-title"><svg-icon icon-class="component" />退费组件</div>
              <draggable
                class="components-draggable"
                :list="returnPremines"
                :group="{ name: 'componentsGroup', pull: 'clone', put: false }"
...
export default {
  ...
  methods: {
    ...
    handlerListChange(val) {
      ...
      const loop = (data, parent) => {
        ...
        if (Array.isArray(data)) {
          ...
          canUsedAsPCon(data, parent) ? vm.$store.commit('addPCondition', data) : vm.$store.commit('delPCondition', data.formId)
        }
      }
    ...
    preview() {
      ...
      // 这是使用jsx渲染
      this.$router.push({ name: 'jsxPreviewNew', params: { formData: this.formData } })
    },
    generate(data) {
...
/deep/.drawing-board .active-from-item > .el-form-item {
    outline: 0.01rem solid #19a97b;
}
</style>
